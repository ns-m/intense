...
// тут прописываете запуск
max.call(document.querySelector('.out-3'), 15, 8);
...
document.querySelector('.b-4').addEventListener('click', () => {
  max.call(document.querySelector('.out-4'), 22, 88);
});
...
let ar9 = [66, 120, 55, 33, 77, 22, 81, 15, 105, true];
...
console.log(`Result res10 = ${ar9.some((elem) => typeof elem === 'boolean')}`);
...
let ar10 = [66, 120, 55, 33, 77, 22, 81, 15, 105];

const t14 = t9.bind(
  document.querySelector('.out-14'),
